...
- (IBAction)getDirections:(id)sender {
    ...
    self.myWebView = [[UIWebView alloc] initWithFrame:CGRectMake(0, 50, self.view.bounds.size.width,self.view.bounds.size.height-25)];
    ...
    [self.myWebView addSubview:activityIndicatorView];
    ...
    [self.myWebView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:googleMapUrlString]]];
