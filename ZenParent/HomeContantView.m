...
@interface HomeContantView () <UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UIActionSheetDelegate>
{
...
@implementation HomeContantView
@synthesize cpllection;
@synthesize collectionCell;
@synthesize myArray;
...
- (void)viewDidLoad {
    ...
    self.screenName = @"Home Containt Screen";
    ...
    [self.cpllection addSubview:refreshControl];
    self.cpllection.alwaysBounceVertical = YES;
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    if(![[NSUserDefaults standardUserDefaults] boolForKey:@"LanguageSettings"]) {
        ...
        [self.navigationController.navigationBar.topItem setTitle:@"होम"];
        self.navigationController.navigationBar.titleTextAttributes = @{NSForegroundColorAttributeName: [UIColor whiteColor]};
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CGSize pElementSize3 = CGSizeMake(700, 245);
